                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-11 col-md-12">
                                <div class="hero__caption hero__caption2">
                                    <h1 data-animation="bounceIn" data-delay="0.2s">Cats by Breed</h1>
                                    <!-- Breadcrumb Start -->
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="home.php">Home</a></li>
                                            <li class="breadcrumb-item"><a href="#">Cats by Breed</a></li> 
                                        </ol>
                                    </nav>
                                    <!-- Breadcrumb End -->
                                </div>
        ...
        <div class="courses-area section-padding40 fix">
            <div class="container">
                ...
                <div class="row">
                    ...
                    if (isset($_GET['idrace']) && !empty($_GET['idrace'])) {
                        $b = $_GET['idrace'];
                        $cats = $cCtrl->searchCat($b);
                        ...
                        if ($cats) {
                            ...
                            echo "<p>No cats found for this breed.</p>";
                        }
                    } else {
                        echo "<p>No breed selected.</p>";
                    }
                    ?>
                </div>
            </div>
