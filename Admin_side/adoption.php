    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark" id="sidenav-main" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link text-white active bg-gradient-primary " href="adoption.php">
              ...
              <div class="card my-4">
                ...
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                  <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                    <h6 class="text-white text-capitalize ps-3">Adoptions</h6>
                  </div>
                </div>
                      ...
                      <table class="table align-items-center mb-2">
                        <thead>
                          <tr>
                            ...
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-0">Race</th>
                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ">Name</th>
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-5">Age</th>
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-4">Description</th>
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-4">Adresse</th>
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-5">Phone</th>
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-4">Reason</th>
                          ...
                          <?php
                              ...
                              if ($a) {
                                  foreach ($a as $adopt) {
                                      echo "<tr>";
                                      echo "<td>{$adopt['idCat']}</td>";
                                      echo "<td>{$adopt['idrace']}</td>";
                                      echo "<td class='ps-4'>{$adopt['nameCat']}</td>";
                                      echo "<td class='ps-4'>{$adopt['ageCat']}</td>";
                                      echo "<td class='ps-4'>{$adopt['desCat']}</td>";
                                      echo "<td class='ps-4'>{$adopt['adresse']}</td>";
                                      echo "<td class='ps-4'>{$adopt['phone']}</td>";
                                      echo "<td class='ps-4'>{$adopt['why']}</td>";
                                     
                                      echo "<td class='ps-5'><a href='deleteAdoption.php?id={$adopt['idAdopt']}'>
